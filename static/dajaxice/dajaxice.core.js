...
var Dajaxice = {
    ...
    disp: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.disp', 'POST', callback_function, argv, custom_settings);
    },
    ...
    aggiorna_statistiche: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.aggiorna_statistiche', 'POST', callback_function, argv, custom_settings);
    },
    ...
    elenco_cerca_persone: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.elenco_cerca_persone', 'POST', callback_function, argv, custom_settings);
    },
    ...
    persona_stato: function(callback_function, argv, custom_settings){
        Dajaxice.call('get2.calendario.persona_stato', 'POST', callback_function, argv, custom_settings);
    },
