...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'persone_persona', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['auth.User']))
        # Adding field 'Gruppo.escludi_stat'
        db.add_column(u'persone_gruppo', 'escludi_stat',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Persona.user'
        db.alter_column(u'persone_persona', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, null=True, to=orm['auth.User']))
        # Deleting field 'Gruppo.escludi_stat'
        db.delete_column(u'persone_gruppo', 'escludi_stat')
