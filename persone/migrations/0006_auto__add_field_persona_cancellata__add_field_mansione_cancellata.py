...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.cancellata'
        db.add_column(u'persone_persona', 'cancellata',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Mansione.cancellata'
        db.add_column(u'persone_mansione', 'cancellata',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.cancellata'
        db.delete_column(u'persone_persona', 'cancellata')

        # Deleting field 'Mansione.cancellata'
        db.delete_column(u'persone_mansione', 'cancellata')
