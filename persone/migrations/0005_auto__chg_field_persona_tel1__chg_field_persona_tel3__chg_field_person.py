...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.tel1'
        db.alter_column(u'persone_persona', 'tel1', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Persona.tel3'
        db.alter_column(u'persone_persona', 'tel3', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Persona.tel2'
        db.alter_column(u'persone_persona', 'tel2', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
        # Adding field 'Mansione.ereditabile'
        db.add_column(u'persone_mansione', 'ereditabile',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Persona.tel1'
        db.alter_column(u'persone_persona', 'tel1', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Persona.tel3'
        db.alter_column(u'persone_persona', 'tel3', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Persona.tel2'
        db.alter_column(u'persone_persona', 'tel2', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
        # Deleting field 'Mansione.ereditabile'
        db.delete_column(u'persone_mansione', 'ereditabile')
