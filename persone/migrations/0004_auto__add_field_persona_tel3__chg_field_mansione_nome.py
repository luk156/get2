...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.tel3'
        db.add_column(u'persone_persona', 'tel3',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Mansione.nome'
        db.alter_column(u'persone_mansione', 'nome', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        # Deleting field 'Persona.tel3'
        db.delete_column(u'persone_persona', 'tel3')


        # Changing field 'Mansione.nome'
        db.alter_column(u'persone_mansione', 'nome', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'persone.persona': {
            ...
            'tel3': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
