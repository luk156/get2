...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.dipendente'
        db.add_column(u'persone_persona', 'dipendente',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.dipendente'
        db.delete_column(u'persone_persona', 'dipendente')
