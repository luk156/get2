...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.notificaSMS'
        db.add_column(u'persone_persona', 'notificaSMS',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.notificaSMS'
        db.delete_column(u'persone_persona', 'notificaSMS')
