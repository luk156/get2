...
def aggiorna_statistiche(request,da,al,mansioni,gruppi):
        ...
        persone, serie_tot_turni=statistiche_intervallo(request,data_da,data_al,elenco_mansioni,elenco_gruppi,senza_gruppo)
        html_statistiche = render_to_string( 'statistiche/statistiche.html', { 'persone': persone, 'serie_tot_turni': serie_tot_turni,'FiltroStatistiche':FiltroStatistiche() ,'request':request } )
