...
var Dajaxice = {
    ...
    mansione_form: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.mansione_form', 'POST', callback_function, argv, custom_settings);
    },

    disp: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.disp', 'POST', callback_function, argv, custom_settings);
    },

    elimina_persona: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.elimina_persona', 'POST', callback_function, argv, custom_settings);
    },

    occorrenze: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.occorrenze', 'POST', callback_function, argv, custom_settings);
    },

    notifiche: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.notifiche', 'POST', callback_function, argv, custom_settings);
    },

    utente_persona: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.utente_persona', 'POST', callback_function, argv, custom_settings);
    },

    elimina_utente: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.elimina_utente', 'POST', callback_function, argv, custom_settings);
    },

    utente_staff: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.utente_staff', 'POST', callback_function, argv, custom_settings);
    },

    elimina_tipo_turno: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.elimina_tipo_turno', 'POST', callback_function, argv, custom_settings);
    },

    disp_nota: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.disp_nota', 'POST', callback_function, argv, custom_settings);
    },

    persona_stato: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.persona_stato', 'POST', callback_function, argv, custom_settings);
    },

    elimina_gruppo: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.elimina_gruppo', 'POST', callback_function, argv, custom_settings);
    },

    tipo_turno_form: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.tipo_turno_form', 'POST', callback_function, argv, custom_settings);
    },

    mansioni_disponibili: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get2.calendario.mansioni_disponibili', 'POST', callback_function, argv, custom_settings);
    }
