...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipoTurno.priorita'
        db.add_column(u'calendario_tipoturno', 'priorita',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipoTurno.priorita'
        db.delete_column(u'calendario_tipoturno', 'priorita')
