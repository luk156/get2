...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requisito.ignora_gerarchie'
        db.add_column(u'calendario_requisito', 'ignora_gerarchie',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requisito.ignora_gerarchie'
        db.delete_column(u'calendario_requisito', 'ignora_gerarchie')
