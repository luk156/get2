...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('calendario_persona', 'nascita', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Persona.nascita'
        db.alter_column('calendario_persona', 'nascita', self.gf('django.db.models.fields.DateTimeField')())
