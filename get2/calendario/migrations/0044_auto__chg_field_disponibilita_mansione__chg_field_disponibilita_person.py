...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'calendario_disponibilita', 'mansione_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['persone.Mansione']))

        # Changing field 'Disponibilita.persona'
        db.alter_column(u'calendario_disponibilita', 'persona_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['persone.Persona']))

    def backwards(self, orm):

        # Changing field 'Disponibilita.mansione'
        db.alter_column(u'calendario_disponibilita', 'mansione_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['persone.Mansione'], on_delete=models.SET_NULL))
