...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requisito.nascosto'
        db.add_column(u'calendario_requisito', 'nascosto',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requisito.nascosto'
        db.delete_column(u'calendario_requisito', 'nascosto')
