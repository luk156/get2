...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.tel1'
        db.add_column('calendario_persona', 'tel1',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=20),
                      keep_default=False)

        # Adding field 'Persona.tel2'
        db.add_column('calendario_persona', 'tel2',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.tel1'
        db.delete_column('calendario_persona', 'tel1')

        # Deleting field 'Persona.tel2'
        db.delete_column('calendario_persona', 'tel2')
    ...
    models = {
        ...
        'calendario.persona': {
            ...
            'tel2': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
