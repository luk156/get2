...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipoTurno.msg_errore'
        db.add_column(u'calendario_tipoturno', 'msg_errore',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipoTurno.msg_errore'
        db.delete_column(u'calendario_tipoturno', 'msg_errore')
