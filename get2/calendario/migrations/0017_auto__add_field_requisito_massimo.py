...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Requisito.massimo'
        db.add_column('calendario_requisito', 'massimo',
                      self.gf('django.db.models.fields.IntegerField')(default=99),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requisito.massimo'
        db.delete_column('calendario_requisito', 'massimo')
    ...
    models = {
        ...
        'calendario.requisito': {
            ...
            'massimo': ('django.db.models.fields.IntegerField', [], {'default': '99'}),
        ...
        'eav.value': {
            ...
            'value_textarea': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        'sites.site': {
