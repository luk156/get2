...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Persona.retraining'
        db.alter_column(u'calendario_persona', 'retraining', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 28, 0, 0)))

        # Changing field 'Persona.retraining_blsd'
        db.alter_column(u'calendario_persona', 'retraining_blsd', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 28, 0, 0)))
