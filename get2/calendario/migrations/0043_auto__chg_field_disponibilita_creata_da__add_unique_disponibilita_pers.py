...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Disponibilita.creata_da'
        db.alter_column(u'calendario_disponibilita', 'creata_da_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
        # Adding unique constraint on 'Disponibilita', fields ['persona', 'turno']
        # db.create_unique(u'calendario_disponibilita', ['persona_id', 'turno_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Disponibilita', fields ['persona', 'turno']
        # db.delete_unique(u'calendario_disponibilita', ['persona_id', 'turno_id'])


        # User chose to not deal with backwards NULL issues for 'Disponibilita.creata_da'
        raise RuntimeError("Cannot reverse this migration. 'Disponibilita.creata_da' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Disponibilita.creata_da'
        db.alter_column(u'calendario_disponibilita', 'creata_da_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
