...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'calendario_impostazioni_notifica', 'giorni', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Persona.retraining'
        db.alter_column(u'calendario_persona', 'retraining', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 4, 3, 0, 0)))

        # Changing field 'Persona.retraining_blsd'
        db.alter_column(u'calendario_persona', 'retraining_blsd', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 4, 3, 0, 0)))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Persona.retraining'
        db.alter_column(u'calendario_persona', 'retraining', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Persona.retraining_blsd'
        db.alter_column(u'calendario_persona', 'retraining_blsd', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        u'calendario.impostazioni_notifica': {
            ...
            'giorni': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'calendario.persona': {
            ...
            'note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'retraining': ('django.db.models.fields.DateField', [], {}),
            'retraining_blsd': ('django.db.models.fields.DateField', [], {}),
