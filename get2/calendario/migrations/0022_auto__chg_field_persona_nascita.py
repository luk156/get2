...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.nascita'
        db.alter_column('calendario_persona', 'nascita', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Persona.nascita'
        db.alter_column('calendario_persona', 'nascita', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 27, 0, 0)))
