...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.indirizzo'
        db.add_column('calendario_persona', 'indirizzo',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Persona.retraining'
        db.add_column('calendario_persona', 'retraining',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 27, 0, 0)),
                      keep_default=False)

        # Adding field 'Persona.retraining_blsd'
        db.add_column('calendario_persona', 'retraining_blsd',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 27, 0, 0)),
                      keep_default=False)


        # Changing field 'Persona.tel2'
        db.alter_column('calendario_persona', 'tel2', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):
        # Deleting field 'Persona.indirizzo'
        db.delete_column('calendario_persona', 'indirizzo')

        # Deleting field 'Persona.retraining'
        db.delete_column('calendario_persona', 'retraining')

        # Deleting field 'Persona.retraining_blsd'
        db.delete_column('calendario_persona', 'retraining_blsd')


        # Changing field 'Persona.tel2'
        db.alter_column('calendario_persona', 'tel2', self.gf('django.db.models.fields.CharField')(default=0, max_length=20))
