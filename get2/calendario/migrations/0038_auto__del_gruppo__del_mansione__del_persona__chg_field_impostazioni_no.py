...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Adding model 'Gruppo'
        db.create_table(u'calendario_gruppo', (
            ('note', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'calendario', ['Gruppo'])

        # Adding M2M table for field componenti on 'Gruppo'
        m2m_table_name = db.shorten_name(u'calendario_gruppo_componenti')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gruppo', models.ForeignKey(orm[u'calendario.gruppo'], null=False)),
            ('persona', models.ForeignKey(orm[u'calendario.persona'], null=False))
        ))
        db.create_unique(m2m_table_name, ['gruppo_id', 'persona_id'])

        # Adding model 'Mansione'
        db.create_table(u'calendario_mansione', (
            ('colore', self.gf('django.db.models.fields.TextField')(default='#aaa')),
            ('padre', self.gf('get2.calendario.models.SelfForeignKey')(related_name='children', null=True, to=orm['calendario.Mansione'], blank=True)),
        ...
        db.send_create_signal(u'calendario', ['Mansione'])

        # Adding model 'Persona'
        db.create_table(u'calendario_persona', (
            ...
            ('retraining', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pers_user', unique=True, null=True, to=orm['auth.User'], blank=True)),
            ('retraining_blsd', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'calendario', ['Persona'])

        # Adding M2M table for field competenze on 'Persona'
        m2m_table_name = db.shorten_name(u'calendario_persona_competenze')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('persona', models.ForeignKey(orm[u'calendario.persona'], null=False)),
            ('mansione', models.ForeignKey(orm[u'calendario.mansione'], null=False))
        ))
        ...
        # Changing field 'Disponibilita.mansione'
        db.alter_column(u'calendario_disponibilita', 'mansione_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['calendario.Mansione'], on_delete=models.SET_NULL))

        # Changing field 'Disponibilita.persona'
        db.alter_column(u'calendario_disponibilita', 'persona_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendario.Persona']))

        # Changing field 'Requisito.mansione'
        db.alter_column(u'calendario_requisito', 'mansione_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendario.Mansione']))
