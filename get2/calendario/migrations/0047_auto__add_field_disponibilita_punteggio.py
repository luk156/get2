...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Disponibilita.punteggio'
        db.add_column(u'calendario_disponibilita', 'punteggio',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Disponibilita.punteggio'
        db.delete_column(u'calendario_disponibilita', 'punteggio')
    ...
    models = {
        ...
        u'calendario.disponibilita': {
            ...
            'punteggio': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
        ...
        u'calendario.turno': {
            ...
            'calendario': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'calendario_turno'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['calendario.Calendario']"}),
            ...
            'tipo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tipo_turno_turno'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['calendario.TipoTurno']"}),
        ...
        u'persone.persona': {
            ...
            'competenze': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'competenze_persona'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['persone.Mansione']"}),
            'dipendente': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'notificaSMS': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
