...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Turno.calendario'
        db.add_column(u'calendario_turno', 'calendario',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendario.Calendario'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Turno.calendario'
        db.delete_column(u'calendario_turno', 'calendario_id')
    ...
    models = {
        ...
        u'calendario.turno': {
            ...
            'calendario': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['calendario.Calendario']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
