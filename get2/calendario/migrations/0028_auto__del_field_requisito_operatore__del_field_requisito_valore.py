...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Requisito.operatore'
        db.delete_column(u'calendario_requisito', 'operatore')

        # Deleting field 'Requisito.valore'
        db.delete_column(u'calendario_requisito', 'valore')


    def backwards(self, orm):
        # Adding field 'Requisito.operatore'
        db.add_column(u'calendario_requisito', 'operatore',
                      self.gf('django.db.models.fields.CharField')(default='>', max_length=10),
                      keep_default=False)

        # Adding field 'Requisito.valore'
        db.add_column(u'calendario_requisito', 'valore',
