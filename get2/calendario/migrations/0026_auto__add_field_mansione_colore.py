...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mansione.colore'
        db.add_column(u'calendario_mansione', 'colore',
                      self.gf('django.db.models.fields.TextField')(default='#7bd148'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mansione.colore'
        db.delete_column(u'calendario_mansione', 'colore')
    ...
    models = {
        ...
        u'calendario.mansione': {
            ...
            'colore': ('django.db.models.fields.TextField', [], {'default': "'#7bd148'"}),
