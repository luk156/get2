...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field disponibilita on 'Cache_requisito'
        m2m_table_name = db.shorten_name(u'calendario_cache_requisito_disponibilita')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cache_requisito', models.ForeignKey(orm[u'calendario.cache_requisito'], null=False)),
            ('disponibilita', models.ForeignKey(orm[u'calendario.disponibilita'], null=False))
        ))
        db.create_unique(m2m_table_name, ['cache_requisito_id', 'disponibilita_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field disponibilita on 'Cache_requisito'
        db.delete_table(db.shorten_name(u'calendario_cache_requisito_disponibilita'))
