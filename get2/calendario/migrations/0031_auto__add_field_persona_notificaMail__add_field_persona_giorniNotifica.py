...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.notificaMail'
        db.add_column(u'calendario_persona', 'notificaMail',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Persona.giorniNotificaMail'
        db.add_column(u'calendario_persona', 'giorniNotificaMail',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.notificaMail'
        db.delete_column(u'calendario_persona', 'notificaMail')

        # Deleting field 'Persona.giorniNotificaMail'
        db.delete_column(u'calendario_persona', 'giorniNotificaMail')
