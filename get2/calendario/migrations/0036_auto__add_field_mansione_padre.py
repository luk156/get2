...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'calendario_mansione', 'padre',
                      self.gf('get2.calendario.models.SelfForeignKey')(blank=True, related_name='children', null=True, to=orm['calendario.Mansione']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mansione.padre'
        db.delete_column(u'calendario_mansione', 'padre_id')
    ...
    models = {
        ...
        u'calendario.mansione': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'padre': ('get2.calendario.models.SelfForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['calendario.Mansione']"})
        },
